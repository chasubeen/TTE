...
from src.backbones.dinov1 import vision_transformer
from src.backbones.dinov2.models import vision_transformer as vision_transformer_dinov2
from src.backbones.beit.vision_transformer import beitv2_base_patch16_448, beitv2_base_patch16_224
...
def load(name):
    ...
    if "digpt" in name:
        if arch == 'base':
            ...
            raise ValueError('Arch not supported in D-iGPT, must be base.')
